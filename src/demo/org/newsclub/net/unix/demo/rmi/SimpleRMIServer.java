...
/**
 * A very simple RMI server. Provides a registry and the implementation of the
...
public class SimpleRMIServer {
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Binding " + obj.toString()
                + " to \"helloWorld\"...");
        final Remote remote = UnicastRemoteObject.exportObject(obj, 0, naming
                .getSocketFactory(), naming.getSocketFactory());
