...
public interface PortAssigner extends Remote {
    /**
     * Registers a new anonymous port and returns it. When the port is not
     * required anymore, it must be returned via {@link #returnPort(int)}.
     * 
     * @return
     * @throws IOException
     */
    ...
    /**
     * Returns a previously registered port. No error is thrown if the given
     * port has not been assigned before.
     * 
     * @param port
     * @throws IOException
     */
