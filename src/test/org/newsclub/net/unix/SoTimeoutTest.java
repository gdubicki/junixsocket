 ...
 * 
 * @see <a href="http://code.google.com/p/junixsocket/issues/detail?id=14">Issue
 *      14</a>
 */
public class SoTimeoutTest extends SocketTestBase {
    ...
    /**
     * Triggers a case where {@link Socket#setSoTimeout(int)} fails on some
     * platforms: when the socket is closed.
     */
    @Test
    ...
    /**
     * Triggers a regular case where {@link Socket#setSoTimeout(int)} should
     * work.
     */
    @Test
